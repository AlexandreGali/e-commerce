...
<div class="container-description-bottle">
    <div class="container-gauche-bottle">
        <div class="descriptif-produit-bottle">
            <div class="partie-superieure-bottle">
                ...
                <p><i class="fa-solid fa-star" style="color: #000000;"></i><i class="fa-solid fa-star" style="color: #000000;"></i><i class="fa-solid fa-star" style="color: #000000;"></i><i class="fa-solid fa-star" style="color: #000000;"></i><i class="fa-solid fa-star" style="color: #000000;"></i>      15 reviews</p>
            </div>
            <div class="partie-milieu-bottle">
                <p>Golden Hour is made with lemon balm and L-theanine derived from green tea,<br>botanicals known to enhance focus and promote relaxation. Bright and bracing, the<br>zest and zing from sunny citrus notes of yuzu and bergamot balance bitter botanicals<br>like hops, sage, and bay leaf for the bite you crave.</p>
            </div>
            <div class="partie-milieu-li-bottle">
                <li>
                    <ul>Non-alcoholic</ul>
                    <ul>50 calories per can</ul>
            ...
            <a href="index.php?page=4&product=bottle" class="partie-lower-bottle" id="can-golden3">
  ...
  <div class="slider10">
    <div class="slide10">
      <div class="content10">
        <img src="../../e-commerce/public/assets/img/golden/produit-golden-can-slider.png" class="img4-slider-can-bottle" alt="can">
      </div>
    </div>

    <div class="slide10">
      <div class="content10">
        <img src="../../e-commerce/public/assets/img/golden/produit-golden-can-hover-slider.png" alt="can2" class="img5-slider-can-bottle">
      </div>
    </div>

    <div class="slide10">
      <div class="content10">
        <img src="../../e-commerce/public/assets/img/golden/slider-can-golden.png" alt="img3slide">
      </div>
    </div>

    <div class="slide10">
      <div class="content10">
        <img src="../../e-commerce/public/assets/img/golden/slider-can-golden2.png" alt="img4slide">
      </div>
    </div>
  </div>
